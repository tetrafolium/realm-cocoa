...
- (void)testDeleteObjectsInRealm {
  ...
  RLMAssertThrowsWithReason([realm deleteObjects:optUnmanaged.dateObj],
                            @"Cannot delete objects from RLMArray");
  RLMAssertThrowsWithReason([realm deleteObjects:managed.boolObj],
                            @"Cannot delete objects from RLMArray");
  RLMAssertThrowsWithReason([realm deleteObjects:managed.intObj],
                            @"Cannot delete objects from RLMArray");
  RLMAssertThrowsWithReason([realm deleteObjects:managed.floatObj],
                            @"Cannot delete objects from RLMArray");
  RLMAssertThrowsWithReason([realm deleteObjects:managed.doubleObj],
                            @"Cannot delete objects from RLMArray");
  RLMAssertThrowsWithReason([realm deleteObjects:managed.stringObj],
                            @"Cannot delete objects from RLMArray");
  RLMAssertThrowsWithReason([realm deleteObjects:managed.dataObj],
                            @"Cannot delete objects from RLMArray");
  RLMAssertThrowsWithReason([realm deleteObjects:managed.dateObj],
                            @"Cannot delete objects from RLMArray");
  RLMAssertThrowsWithReason([realm deleteObjects:optManaged.boolObj],
                            @"Cannot delete objects from RLMArray");
  RLMAssertThrowsWithReason([realm deleteObjects:optManaged.intObj],
                            @"Cannot delete objects from RLMArray");
  RLMAssertThrowsWithReason([realm deleteObjects:optManaged.floatObj],
                            @"Cannot delete objects from RLMArray");
  RLMAssertThrowsWithReason([realm deleteObjects:optManaged.doubleObj],
                            @"Cannot delete objects from RLMArray");
  RLMAssertThrowsWithReason([realm deleteObjects:optManaged.stringObj],
                            @"Cannot delete objects from RLMArray");
  RLMAssertThrowsWithReason([realm deleteObjects:optManaged.dataObj],
                            @"Cannot delete objects from RLMArray");
  RLMAssertThrowsWithReason([realm deleteObjects:optManaged.dateObj],
                            @"Cannot delete objects from RLMArray");
}
...
- (void)testAddObject {
  RLMAssertThrowsWithReason([unmanaged.boolObj addObject:@"a"],
                            @"Invalid value 'a' of type '__NSCFConstantString' "
  ...
  RLMAssertThrowsWithReason(
      [unmanaged.stringObj addObject:@2],
  ...
  RLMAssertThrowsWithReason([optUnmanaged.doubleObj addObject:@"a"],
                            ...
                            @"for expected type 'double?'");
  RLMAssertThrowsWithReason(
      [optUnmanaged.stringObj addObject:@2],
      @"Invalid value '2' of type '__NSCFNumber' for expected type 'string?'");
  ...
  RLMAssertThrowsWithReason([optManaged.doubleObj addObject:@"a"],
                            ...
                            @"for expected type 'double?'");
  RLMAssertThrowsWithReason(
      [optManaged.stringObj addObject:@2],
      @"Invalid value '2' of type '__NSCFNumber' for expected type 'string?'");
...
- (void)testAddObjects {
  ...
  RLMAssertThrowsWithReason([unmanaged.doubleObj addObjects:@[ @"a" ]],
                            ...
                            @"for expected type 'double'");
  RLMAssertThrowsWithReason(
      [unmanaged.stringObj addObjects:@[ @2 ]],
      @"Invalid value '2' of type '__NSCFNumber' for expected type 'string'");
  ...
  RLMAssertThrowsWithReason([optUnmanaged.doubleObj addObjects:@[ @"a" ]],
                            ...
                            @"for expected type 'double?'");
  RLMAssertThrowsWithReason(
      [optUnmanaged.stringObj addObjects:@[ @2 ]],
      @"Invalid value '2' of type '__NSCFNumber' for expected type 'string?'");
  ...
  RLMAssertThrowsWithReason([managed.doubleObj addObjects:@[ @"a" ]],
                            ...
                            @"for expected type 'double'");
  RLMAssertThrowsWithReason(
      [managed.stringObj addObjects:@[ @2 ]],
      @"Invalid value '2' of type '__NSCFNumber' for expected type 'string'");
  ...
  RLMAssertThrowsWithReason([optManaged.doubleObj addObjects:@[ @"a" ]],
                            ...
                            @"for expected type 'double?'");
  RLMAssertThrowsWithReason(
      [optManaged.stringObj addObjects:@[ @2 ]],
      @"Invalid value '2' of type '__NSCFNumber' for expected type 'string?'");
...
- (void)testInsertObject {
  ...
  RLMAssertThrowsWithReason([unmanaged.doubleObj insertObject:@"a" atIndex:0],
                            ...
                            @"for expected type 'double'");
  RLMAssertThrowsWithReason(
      [unmanaged.stringObj insertObject:@2 atIndex:0],
      @"Invalid value '2' of type '__NSCFNumber' for expected type 'string'");
  ...
  RLMAssertThrowsWithReason([optUnmanaged.doubleObj insertObject:@"a"
                            ...
                            @"for expected type 'double?'");
  RLMAssertThrowsWithReason(
      [optUnmanaged.stringObj insertObject:@2 atIndex:0],
      @"Invalid value '2' of type '__NSCFNumber' for expected type 'string?'");
  ...
  RLMAssertThrowsWithReason([managed.doubleObj insertObject:@"a" atIndex:0],
                            ...
                            @"for expected type 'double'");
  RLMAssertThrowsWithReason(
      [managed.stringObj insertObject:@2 atIndex:0],
      @"Invalid value '2' of type '__NSCFNumber' for expected type 'string'");
  ...
  RLMAssertThrowsWithReason([optManaged.doubleObj insertObject:@"a" atIndex:0],
                            ...
                            @"for expected type 'double?'");
  RLMAssertThrowsWithReason(
      [optManaged.stringObj insertObject:@2 atIndex:0],
      @"Invalid value '2' of type '__NSCFNumber' for expected type 'string?'");
...
- (void)testReplace {
  ...
  RLMAssertThrowsWithReason([unmanaged.doubleObj replaceObjectAtIndex:0
                            ...
                            @"for expected type 'double'");
  RLMAssertThrowsWithReason(
      [unmanaged.stringObj replaceObjectAtIndex:0 withObject:@2],
      @"Invalid value '2' of type '__NSCFNumber' for expected type 'string'");
  RLMAssertThrowsWithReason([unmanaged.dataObj replaceObjectAtIndex:0
                                                         withObject:@"a"],
                            @"Invalid value 'a' of type '__NSCFConstantString' "
  ...
  RLMAssertThrowsWithReason([optUnmanaged.doubleObj replaceObjectAtIndex:0
                            ...
                            @"for expected type 'double?'");
  RLMAssertThrowsWithReason(
      [optUnmanaged.stringObj replaceObjectAtIndex:0 withObject:@2],
      @"Invalid value '2' of type '__NSCFNumber' for expected type 'string?'");
  RLMAssertThrowsWithReason([optUnmanaged.dataObj replaceObjectAtIndex:0
                                                            withObject:@"a"],
                            @"Invalid value 'a' of type '__NSCFConstantString' "
  ...
  RLMAssertThrowsWithReason([managed.doubleObj replaceObjectAtIndex:0
                            ...
                            @"for expected type 'double'");
  RLMAssertThrowsWithReason(
      [managed.stringObj replaceObjectAtIndex:0 withObject:@2],
      @"Invalid value '2' of type '__NSCFNumber' for expected type 'string'");
  RLMAssertThrowsWithReason([managed.dataObj replaceObjectAtIndex:0
                                                       withObject:@"a"],
                            @"Invalid value 'a' of type '__NSCFConstantString' "
  ...
  RLMAssertThrowsWithReason([optManaged.doubleObj replaceObjectAtIndex:0
                            ...
                            @"for expected type 'double?'");
  RLMAssertThrowsWithReason(
      [optManaged.stringObj replaceObjectAtIndex:0 withObject:@2],
      @"Invalid value '2' of type '__NSCFNumber' for expected type 'string?'");
  RLMAssertThrowsWithReason([optManaged.dataObj replaceObjectAtIndex:0
                                                          withObject:@"a"],
                            @"Invalid value 'a' of type '__NSCFConstantString' "
...
- (void)testMove {
  ...
  RLMAssertThrowsWithReason([unmanaged.dateObj moveObjectAtIndex:0 toIndex:1],
                            @"Index 0 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optUnmanaged.boolObj moveObjectAtIndex:0
                                                            toIndex:1],
                            @"Index 0 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optUnmanaged.intObj moveObjectAtIndex:0 toIndex:1],
                            @"Index 0 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optUnmanaged.floatObj moveObjectAtIndex:0
                                                             toIndex:1],
                            @"Index 0 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optUnmanaged.doubleObj moveObjectAtIndex:0
                                                              toIndex:1],
                            @"Index 0 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optUnmanaged.stringObj moveObjectAtIndex:0
                                                              toIndex:1],
                            @"Index 0 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optUnmanaged.dataObj moveObjectAtIndex:0
                                                            toIndex:1],
                            @"Index 0 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optUnmanaged.dateObj moveObjectAtIndex:0
                                                            toIndex:1],
                            @"Index 0 is out of bounds (must be less than 0).");
  ...
  RLMAssertThrowsWithReason([optManaged.floatObj moveObjectAtIndex:0 toIndex:1],
                            @"Index 0 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optManaged.doubleObj moveObjectAtIndex:0
                                                            toIndex:1],
                            @"Index 0 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optManaged.stringObj moveObjectAtIndex:0
                                                            toIndex:1],
                            @"Index 0 is out of bounds (must be less than 0).");
  ...
  RLMAssertThrowsWithReason([unmanaged.dateObj moveObjectAtIndex:1 toIndex:0],
                            @"Index 1 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optUnmanaged.boolObj moveObjectAtIndex:1
                                                            toIndex:0],
                            @"Index 1 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optUnmanaged.intObj moveObjectAtIndex:1 toIndex:0],
                            @"Index 1 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optUnmanaged.floatObj moveObjectAtIndex:1
                                                             toIndex:0],
                            @"Index 1 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optUnmanaged.doubleObj moveObjectAtIndex:1
                                                              toIndex:0],
                            @"Index 1 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optUnmanaged.stringObj moveObjectAtIndex:1
                                                              toIndex:0],
                            @"Index 1 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optUnmanaged.dataObj moveObjectAtIndex:1
                                                            toIndex:0],
                            @"Index 1 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optUnmanaged.dateObj moveObjectAtIndex:1
                                                            toIndex:0],
                            @"Index 1 is out of bounds (must be less than 0).");
  ...
  RLMAssertThrowsWithReason([optManaged.floatObj moveObjectAtIndex:1 toIndex:0],
                            @"Index 1 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optManaged.doubleObj moveObjectAtIndex:1
                                                            toIndex:0],
                            @"Index 1 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optManaged.stringObj moveObjectAtIndex:1
                                                            toIndex:0],
                            @"Index 1 is out of bounds (must be less than 0).");
...
- (void)testExchange {
  RLMAssertThrowsWithReason([unmanaged.boolObj exchangeObjectAtIndex:0
                                                   withObjectAtIndex:1],
                            @"Index 0 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([unmanaged.intObj exchangeObjectAtIndex:0
                                                  withObjectAtIndex:1],
                            @"Index 0 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([unmanaged.floatObj exchangeObjectAtIndex:0
                                                    withObjectAtIndex:1],
                            @"Index 0 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([unmanaged.doubleObj exchangeObjectAtIndex:0
                                                     withObjectAtIndex:1],
                            @"Index 0 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([unmanaged.stringObj exchangeObjectAtIndex:0
                                                     withObjectAtIndex:1],
                            @"Index 0 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([unmanaged.dataObj exchangeObjectAtIndex:0
                                                   withObjectAtIndex:1],
                            @"Index 0 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([unmanaged.dateObj exchangeObjectAtIndex:0
                                                   withObjectAtIndex:1],
                            @"Index 0 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optUnmanaged.boolObj exchangeObjectAtIndex:0
                                                      withObjectAtIndex:1],
                            @"Index 0 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optUnmanaged.intObj exchangeObjectAtIndex:0
                                                     withObjectAtIndex:1],
                            @"Index 0 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optUnmanaged.floatObj exchangeObjectAtIndex:0
                                                       withObjectAtIndex:1],
                            @"Index 0 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optUnmanaged.doubleObj exchangeObjectAtIndex:0
                                                        withObjectAtIndex:1],
                            @"Index 0 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optUnmanaged.stringObj exchangeObjectAtIndex:0
                                                        withObjectAtIndex:1],
                            @"Index 0 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optUnmanaged.dataObj exchangeObjectAtIndex:0
                                                      withObjectAtIndex:1],
                            @"Index 0 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optUnmanaged.dateObj exchangeObjectAtIndex:0
                                                      withObjectAtIndex:1],
                            @"Index 0 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([managed.boolObj exchangeObjectAtIndex:0
                                                 withObjectAtIndex:1],
                            @"Index 0 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([managed.intObj exchangeObjectAtIndex:0
                                                withObjectAtIndex:1],
                            @"Index 0 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([managed.floatObj exchangeObjectAtIndex:0
                                                  withObjectAtIndex:1],
                            @"Index 0 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([managed.doubleObj exchangeObjectAtIndex:0
                                                   withObjectAtIndex:1],
                            @"Index 0 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([managed.stringObj exchangeObjectAtIndex:0
                                                   withObjectAtIndex:1],
                            @"Index 0 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([managed.dataObj exchangeObjectAtIndex:0
                                                 withObjectAtIndex:1],
                            @"Index 0 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([managed.dateObj exchangeObjectAtIndex:0
                                                 withObjectAtIndex:1],
                            @"Index 0 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optManaged.boolObj exchangeObjectAtIndex:0
                                                    withObjectAtIndex:1],
                            @"Index 0 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optManaged.intObj exchangeObjectAtIndex:0
                                                   withObjectAtIndex:1],
                            @"Index 0 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optManaged.floatObj exchangeObjectAtIndex:0
                                                     withObjectAtIndex:1],
                            @"Index 0 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optManaged.doubleObj exchangeObjectAtIndex:0
                                                      withObjectAtIndex:1],
                            @"Index 0 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optManaged.stringObj exchangeObjectAtIndex:0
                                                      withObjectAtIndex:1],
                            @"Index 0 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optManaged.dataObj exchangeObjectAtIndex:0
                                                    withObjectAtIndex:1],
                            @"Index 0 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optManaged.dateObj exchangeObjectAtIndex:0
                                                    withObjectAtIndex:1],
                            @"Index 0 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([unmanaged.boolObj exchangeObjectAtIndex:1
                                                   withObjectAtIndex:0],
                            @"Index 1 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([unmanaged.intObj exchangeObjectAtIndex:1
                                                  withObjectAtIndex:0],
                            @"Index 1 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([unmanaged.floatObj exchangeObjectAtIndex:1
                                                    withObjectAtIndex:0],
                            @"Index 1 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([unmanaged.doubleObj exchangeObjectAtIndex:1
                                                     withObjectAtIndex:0],
                            @"Index 1 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([unmanaged.stringObj exchangeObjectAtIndex:1
                                                     withObjectAtIndex:0],
                            @"Index 1 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([unmanaged.dataObj exchangeObjectAtIndex:1
                                                   withObjectAtIndex:0],
                            @"Index 1 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([unmanaged.dateObj exchangeObjectAtIndex:1
                                                   withObjectAtIndex:0],
                            @"Index 1 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optUnmanaged.boolObj exchangeObjectAtIndex:1
                                                      withObjectAtIndex:0],
                            @"Index 1 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optUnmanaged.intObj exchangeObjectAtIndex:1
                                                     withObjectAtIndex:0],
                            @"Index 1 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optUnmanaged.floatObj exchangeObjectAtIndex:1
                                                       withObjectAtIndex:0],
                            @"Index 1 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optUnmanaged.doubleObj exchangeObjectAtIndex:1
                                                        withObjectAtIndex:0],
                            @"Index 1 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optUnmanaged.stringObj exchangeObjectAtIndex:1
                                                        withObjectAtIndex:0],
                            @"Index 1 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optUnmanaged.dataObj exchangeObjectAtIndex:1
                                                      withObjectAtIndex:0],
                            @"Index 1 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optUnmanaged.dateObj exchangeObjectAtIndex:1
                                                      withObjectAtIndex:0],
                            @"Index 1 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([managed.boolObj exchangeObjectAtIndex:1
                                                 withObjectAtIndex:0],
                            @"Index 1 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([managed.intObj exchangeObjectAtIndex:1
                                                withObjectAtIndex:0],
                            @"Index 1 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([managed.floatObj exchangeObjectAtIndex:1
                                                  withObjectAtIndex:0],
                            @"Index 1 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([managed.doubleObj exchangeObjectAtIndex:1
                                                   withObjectAtIndex:0],
                            @"Index 1 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([managed.stringObj exchangeObjectAtIndex:1
                                                   withObjectAtIndex:0],
                            @"Index 1 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([managed.dataObj exchangeObjectAtIndex:1
                                                 withObjectAtIndex:0],
                            @"Index 1 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([managed.dateObj exchangeObjectAtIndex:1
                                                 withObjectAtIndex:0],
                            @"Index 1 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optManaged.boolObj exchangeObjectAtIndex:1
                                                    withObjectAtIndex:0],
                            @"Index 1 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optManaged.intObj exchangeObjectAtIndex:1
                                                   withObjectAtIndex:0],
                            @"Index 1 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optManaged.floatObj exchangeObjectAtIndex:1
                                                     withObjectAtIndex:0],
                            @"Index 1 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optManaged.doubleObj exchangeObjectAtIndex:1
                                                      withObjectAtIndex:0],
                            @"Index 1 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optManaged.stringObj exchangeObjectAtIndex:1
                                                      withObjectAtIndex:0],
                            @"Index 1 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optManaged.dataObj exchangeObjectAtIndex:1
                                                    withObjectAtIndex:0],
                            @"Index 1 is out of bounds (must be less than 0).");
  RLMAssertThrowsWithReason([optManaged.dateObj exchangeObjectAtIndex:1
                                                    withObjectAtIndex:0],
                            @"Index 1 is out of bounds (must be less than 0).");
...
- (void)testIndexOfObject {
  ...
  RLMAssertThrowsWithReason([unmanaged.doubleObj indexOfObject:@"a"],
                            ...
                            @"for expected type 'double'");
  RLMAssertThrowsWithReason(
      [unmanaged.stringObj indexOfObject:@2],
      @"Invalid value '2' of type '__NSCFNumber' for expected type 'string'");
  ...
  RLMAssertThrowsWithReason([optUnmanaged.doubleObj indexOfObject:@"a"],
                            ...
                            @"for expected type 'double?'");
  RLMAssertThrowsWithReason(
      [optUnmanaged.stringObj indexOfObject:@2],
      @"Invalid value '2' of type '__NSCFNumber' for expected type 'string?'");
  ...
  RLMAssertThrowsWithReason([managed.doubleObj indexOfObject:@"a"],
                            ...
                            @"for expected type 'double'");
  RLMAssertThrowsWithReason(
      [managed.stringObj indexOfObject:@2],
      @"Invalid value '2' of type '__NSCFNumber' for expected type 'string'");
  ...
  RLMAssertThrowsWithReason([optManaged.doubleObj indexOfObject:@"a"],
                            ...
                            @"for expected type 'double?'");
  RLMAssertThrowsWithReason(
      [optManaged.stringObj indexOfObject:@2],
      @"Invalid value '2' of type '__NSCFNumber' for expected type 'string?'");
...
- (void)testIndexOfObjectWhere {
  ...
  XCTAssertEqual(NSNotFound,
                 [unmanaged.doubleObj indexOfObjectWhere:@"TRUEPREDICATE"]);
  XCTAssertEqual(NSNotFound,
  ...
  XCTAssertEqual(NSNotFound,
                 [optUnmanaged.doubleObj indexOfObjectWhere:@"TRUEPREDICATE"]);
  XCTAssertEqual(NSNotFound,
  ...
  XCTAssertEqual(0U,
                 [optUnmanaged.dateObj indexOfObjectWhere:@"TRUEPREDICATE"]);
  XCTAssertEqual(NSNotFound,
                 [unmanaged.boolObj indexOfObjectWhere:@"FALSEPREDICATE"]);
  XCTAssertEqual(NSNotFound,
                 [unmanaged.intObj indexOfObjectWhere:@"FALSEPREDICATE"]);
  XCTAssertEqual(NSNotFound,
                 [unmanaged.floatObj indexOfObjectWhere:@"FALSEPREDICATE"]);
  XCTAssertEqual(NSNotFound,
                 [unmanaged.doubleObj indexOfObjectWhere:@"FALSEPREDICATE"]);
  XCTAssertEqual(NSNotFound,
                 [unmanaged.stringObj indexOfObjectWhere:@"FALSEPREDICATE"]);
  XCTAssertEqual(NSNotFound,
                 [unmanaged.dataObj indexOfObjectWhere:@"FALSEPREDICATE"]);
  XCTAssertEqual(NSNotFound,
                 [unmanaged.dateObj indexOfObjectWhere:@"FALSEPREDICATE"]);
  XCTAssertEqual(NSNotFound,
                 [optUnmanaged.boolObj indexOfObjectWhere:@"FALSEPREDICATE"]);
  XCTAssertEqual(NSNotFound,
                 [optUnmanaged.intObj indexOfObjectWhere:@"FALSEPREDICATE"]);
  XCTAssertEqual(NSNotFound,
                 [optUnmanaged.floatObj indexOfObjectWhere:@"FALSEPREDICATE"]);
  XCTAssertEqual(NSNotFound,
                 [optUnmanaged.doubleObj indexOfObjectWhere:@"FALSEPREDICATE"]);
  XCTAssertEqual(NSNotFound,
                 [optUnmanaged.stringObj indexOfObjectWhere:@"FALSEPREDICATE"]);
  XCTAssertEqual(NSNotFound,
                 [optUnmanaged.dataObj indexOfObjectWhere:@"FALSEPREDICATE"]);
  XCTAssertEqual(NSNotFound,
                 [optUnmanaged.dateObj indexOfObjectWhere:@"FALSEPREDICATE"]);
}
...
- (void)testSort {
  ...
  XCTAssertEqualObjects(
      ...
      (@[ @2, @3, @2 ]));
  XCTAssertEqualObjects([[managed.floatObj sortedResultsUsingDescriptors:@[]]
                            valueForKey:@"self"],
                        (@[ @2.2f, @3.3f, @2.2f ]));
  XCTAssertEqualObjects([[managed.doubleObj sortedResultsUsingDescriptors:@[]]
                            valueForKey:@"self"],
                        (@[ @2.2, @3.3, @2.2 ]));
  XCTAssertEqualObjects([[managed.stringObj sortedResultsUsingDescriptors:@[]]
                            valueForKey:@"self"],
                        (@[ @"a", @"b", @"a" ]));
  XCTAssertEqualObjects(
  ...
  XCTAssertEqualObjects([[optManaged.boolObj sortedResultsUsingDescriptors:@[]]
                            valueForKey:@"self"],
                        (@[ @NO, @YES, NSNull.null, @YES, @NO ]));
  XCTAssertEqualObjects([[optManaged.intObj sortedResultsUsingDescriptors:@[]]
                            valueForKey:@"self"],
                        (@[ @2, @3, NSNull.null, @3, @2 ]));
  XCTAssertEqualObjects([[optManaged.floatObj sortedResultsUsingDescriptors:@[]]
                            valueForKey:@"self"],
                        (@[ @2.2f, @3.3f, NSNull.null, @3.3f, @2.2f ]));
  XCTAssertEqualObjects([[optManaged.doubleObj sortedResultsUsingDescriptors:@[
                        ]] valueForKey:@"self"],
                        (@[ @2.2, @3.3, NSNull.null, @3.3, @2.2 ]));
  XCTAssertEqualObjects([[optManaged.stringObj sortedResultsUsingDescriptors:@[
                        ]] valueForKey:@"self"],
                        (@[ @"a", @"b", NSNull.null, @"b", @"a" ]));
  XCTAssertEqualObjects([[optManaged.dataObj sortedResultsUsingDescriptors:@[]]
                            valueForKey:@"self"],
                        (@[ data(1), data(2), NSNull.null, data(2), data(1) ]));
  XCTAssertEqualObjects([[optManaged.dateObj sortedResultsUsingDescriptors:@[]]
                            valueForKey:@"self"],
  ...
  XCTAssertEqualObjects([[optManaged.doubleObj sortedResultsUsingKeyPath:@"self"
                                                               ascending:YES]
                            valueForKey:@"self"],
                        (@[ NSNull.null, @2.2, @2.2, @3.3, @3.3 ]));
  XCTAssertEqualObjects([[optManaged.stringObj sortedResultsUsingKeyPath:@"self"
                                                               ascending:YES]
                            valueForKey:@"self"],
                        (@[ NSNull.null, @"a", @"a", @"b", @"b" ]));
  XCTAssertEqualObjects(
...
- (void)testMin {
  ...
  RLMAssertThrowsWithReason([optManaged.stringObj minOfProperty:@"self"],
                            @"minOfProperty: is not supported for string? "
                            @"array 'AllOptionalPrimitiveArrays.stringObj'");
...
- (void)testMax {
  ...
  RLMAssertThrowsWithReason([optManaged.stringObj maxOfProperty:@"self"],
                            @"maxOfProperty: is not supported for string? "
                            @"array 'AllOptionalPrimitiveArrays.stringObj'");
...
- (void)testSum {
  ...
  RLMAssertThrowsWithReason([optManaged.stringObj sumOfProperty:@"self"],
                            @"sumOfProperty: is not supported for string? "
                            @"array 'AllOptionalPrimitiveArrays.stringObj'");
  ...
  XCTAssertEqualObjects([unmanaged.floatObj sumOfProperty:@"self"],
                        @(2.2f + 3.3f));
  XCTAssertEqualObjects([unmanaged.doubleObj sumOfProperty:@"self"],
                        @(2.2 + 3.3));
  XCTAssertEqualObjects([optUnmanaged.intObj sumOfProperty:@"self"], @(2 + 3));
  XCTAssertEqualObjects([optUnmanaged.floatObj sumOfProperty:@"self"],
                        @(2.2f + 3.3f));
  XCTAssertEqualObjects([optUnmanaged.doubleObj sumOfProperty:@"self"],
                        @(2.2 + 3.3));
  XCTAssertEqualObjects([managed.intObj sumOfProperty:@"self"], @(2 + 3));
  XCTAssertEqualObjects([managed.floatObj sumOfProperty:@"self"],
                        @(2.2f + 3.3f));
  XCTAssertEqualObjects([managed.doubleObj sumOfProperty:@"self"],
                        @(2.2 + 3.3));
  XCTAssertEqualObjects([optManaged.intObj sumOfProperty:@"self"], @(2 + 3));
  XCTAssertEqualObjects([optManaged.floatObj sumOfProperty:@"self"],
                        @(2.2f + 3.3f));
  XCTAssertEqualObjects([optManaged.doubleObj sumOfProperty:@"self"],
                        @(2.2 + 3.3));
}
...
- (void)testAverage {
  ...
  RLMAssertThrowsWithReason([managed.boolObj averageOfProperty:@"self"],
                            @"averageOfProperty: is not supported for bool "
                            @"array 'AllPrimitiveArrays.boolObj'");
  RLMAssertThrowsWithReason([managed.stringObj averageOfProperty:@"self"],
                            @"averageOfProperty: is not supported for string "
                            @"array 'AllPrimitiveArrays.stringObj'");
  RLMAssertThrowsWithReason([managed.dataObj averageOfProperty:@"self"],
                            @"averageOfProperty: is not supported for data "
                            @"array 'AllPrimitiveArrays.dataObj'");
  RLMAssertThrowsWithReason([managed.dateObj averageOfProperty:@"self"],
                            @"averageOfProperty: is not supported for date "
                            @"array 'AllPrimitiveArrays.dateObj'");
  RLMAssertThrowsWithReason([optManaged.boolObj averageOfProperty:@"self"],
                            @"averageOfProperty: is not supported for bool? "
                            @"array 'AllOptionalPrimitiveArrays.boolObj'");
  ...
  RLMAssertThrowsWithReason([optManaged.dataObj averageOfProperty:@"self"],
                            @"averageOfProperty: is not supported for data? "
                            @"array 'AllOptionalPrimitiveArrays.dataObj'");
  RLMAssertThrowsWithReason([optManaged.dateObj averageOfProperty:@"self"],
                            @"averageOfProperty: is not supported for date? "
                            @"array 'AllOptionalPrimitiveArrays.dateObj'");
  ...
  XCTAssertEqualWithAccuracy(
      [unmanaged.intObj averageOfProperty:@"self"].doubleValue, (2 + 3) / 2.0,
      .001);
  XCTAssertEqualWithAccuracy(
  ...
  XCTAssertEqualWithAccuracy(
      ...
      (2.2 + 3.3) / 2.0, .001);
  XCTAssertEqualWithAccuracy(
      [managed.intObj averageOfProperty:@"self"].doubleValue, (2 + 3) / 2.0,
      .001);
  XCTAssertEqualWithAccuracy(
  ...
  XCTAssertEqualWithAccuracy(
      ...
      (2.2 + 3.3) / 2.0, .001);
  XCTAssertEqualWithAccuracy(
      [optManaged.intObj averageOfProperty:@"self"].doubleValue, (2 + 3) / 2.0,
      .001);
  XCTAssertEqualWithAccuracy(
...
- (void)testValueForKeyNumericAggregates {
  ...
  XCTAssertEqualObjects([optUnmanaged.floatObj valueForKeyPath:@"@sum.self"],
                        @0);
  XCTAssertEqualObjects([optUnmanaged.doubleObj valueForKeyPath:@"@sum.self"],
                        @0);
  ...
  XCTAssertEqualObjects([optManaged.doubleObj valueForKeyPath:@"@sum.self"],
                        @0);
  ...
  XCTAssertEqualObjects([unmanaged.floatObj valueForKeyPath:@"@min.self"],
                        @2.2f);
  XCTAssertEqualObjects([unmanaged.doubleObj valueForKeyPath:@"@min.self"],
                        @2.2);
  XCTAssertEqualObjects([unmanaged.dateObj valueForKeyPath:@"@min.self"],
                        date(1));
  XCTAssertEqualObjects([optUnmanaged.intObj valueForKeyPath:@"@min.self"], @2);
  XCTAssertEqualObjects([optUnmanaged.floatObj valueForKeyPath:@"@min.self"],
                        @2.2f);
  XCTAssertEqualObjects([optUnmanaged.doubleObj valueForKeyPath:@"@min.self"],
                        @2.2);
  XCTAssertEqualObjects([optUnmanaged.dateObj valueForKeyPath:@"@min.self"],
                        date(1));
  ...
  XCTAssertEqualObjects([managed.dateObj valueForKeyPath:@"@min.self"],
                        date(1));
  XCTAssertEqualObjects([optManaged.intObj valueForKeyPath:@"@min.self"], @2);
  XCTAssertEqualObjects([optManaged.floatObj valueForKeyPath:@"@min.self"],
                        @2.2f);
  XCTAssertEqualObjects([optManaged.doubleObj valueForKeyPath:@"@min.self"],
                        @2.2);
  XCTAssertEqualObjects([optManaged.dateObj valueForKeyPath:@"@min.self"],
                        date(1));
  XCTAssertEqualObjects([unmanaged.intObj valueForKeyPath:@"@max.self"], @3);
  XCTAssertEqualObjects([unmanaged.floatObj valueForKeyPath:@"@max.self"],
                        @3.3f);
  XCTAssertEqualObjects([unmanaged.doubleObj valueForKeyPath:@"@max.self"],
                        @3.3);
  XCTAssertEqualObjects([unmanaged.dateObj valueForKeyPath:@"@max.self"],
                        date(2));
  XCTAssertEqualObjects([optUnmanaged.intObj valueForKeyPath:@"@max.self"], @3);
  XCTAssertEqualObjects([optUnmanaged.floatObj valueForKeyPath:@"@max.self"],
                        @3.3f);
  XCTAssertEqualObjects([optUnmanaged.doubleObj valueForKeyPath:@"@max.self"],
                        @3.3);
  XCTAssertEqualObjects([optUnmanaged.dateObj valueForKeyPath:@"@max.self"],
                        date(2));
  ...
  XCTAssertEqualObjects([managed.dateObj valueForKeyPath:@"@max.self"],
                        date(2));
  XCTAssertEqualObjects([optManaged.intObj valueForKeyPath:@"@max.self"], @3);
  XCTAssertEqualObjects([optManaged.floatObj valueForKeyPath:@"@max.self"],
                        @3.3f);
  XCTAssertEqualObjects([optManaged.doubleObj valueForKeyPath:@"@max.self"],
                        @3.3);
  XCTAssertEqualObjects([optManaged.dateObj valueForKeyPath:@"@max.self"],
                        date(2));
  XCTAssertEqualObjects([unmanaged.intObj valueForKeyPath:@"@sum.self"],
                        @(2 + 3));
  XCTAssertEqualObjects([unmanaged.floatObj valueForKeyPath:@"@sum.self"],
                        @(2.2f + 3.3f));
  XCTAssertEqualObjects([unmanaged.doubleObj valueForKeyPath:@"@sum.self"],
                        @(2.2 + 3.3));
  XCTAssertEqualObjects([optUnmanaged.intObj valueForKeyPath:@"@sum.self"],
                        @(2 + 3));
  XCTAssertEqualObjects([optUnmanaged.floatObj valueForKeyPath:@"@sum.self"],
                        @(2.2f + 3.3f));
  XCTAssertEqualObjects([optUnmanaged.doubleObj valueForKeyPath:@"@sum.self"],
                        @(2.2 + 3.3));
  XCTAssertEqualObjects([managed.intObj valueForKeyPath:@"@sum.self"],
                        @(2 + 3));
  XCTAssertEqualObjects([managed.floatObj valueForKeyPath:@"@sum.self"],
                        @(2.2f + 3.3f));
  XCTAssertEqualObjects([managed.doubleObj valueForKeyPath:@"@sum.self"],
                        @(2.2 + 3.3));
  XCTAssertEqualObjects([optManaged.intObj valueForKeyPath:@"@sum.self"],
                        @(2 + 3));
  XCTAssertEqualObjects([optManaged.floatObj valueForKeyPath:@"@sum.self"],
                        @(2.2f + 3.3f));
  XCTAssertEqualObjects([optManaged.doubleObj valueForKeyPath:@"@sum.self"],
                        @(2.2 + 3.3));
  XCTAssertEqualWithAccuracy(
...
- (void)testUnionOfObjects {
  ...
  XCTAssertEqualObjects(
      [unmanaged.boolObj valueForKeyPath:@"@distinctUnionOfObjects.self"], @[]);
  XCTAssertEqualObjects(
      [unmanaged.intObj valueForKeyPath:@"@distinctUnionOfObjects.self"], @[]);
  XCTAssertEqualObjects(
      [unmanaged.floatObj valueForKeyPath:@"@distinctUnionOfObjects.self"],
      @[]);
  XCTAssertEqualObjects(
      [unmanaged.doubleObj valueForKeyPath:@"@distinctUnionOfObjects.self"],
      @[]);
  XCTAssertEqualObjects(
      [unmanaged.stringObj valueForKeyPath:@"@distinctUnionOfObjects.self"],
      @[]);
  XCTAssertEqualObjects(
      [unmanaged.dataObj valueForKeyPath:@"@distinctUnionOfObjects.self"], @[]);
  XCTAssertEqualObjects(
      [unmanaged.dateObj valueForKeyPath:@"@distinctUnionOfObjects.self"], @[]);
  XCTAssertEqualObjects(
      [optUnmanaged.boolObj valueForKeyPath:@"@distinctUnionOfObjects.self"],
      @[]);
  XCTAssertEqualObjects(
      [optUnmanaged.intObj valueForKeyPath:@"@distinctUnionOfObjects.self"],
      @[]);
  XCTAssertEqualObjects(
      [optUnmanaged.floatObj valueForKeyPath:@"@distinctUnionOfObjects.self"],
      @[]);
  XCTAssertEqualObjects(
      [optUnmanaged.doubleObj valueForKeyPath:@"@distinctUnionOfObjects.self"],
      @[]);
  XCTAssertEqualObjects(
      [optUnmanaged.stringObj valueForKeyPath:@"@distinctUnionOfObjects.self"],
      @[]);
  XCTAssertEqualObjects(
      [optUnmanaged.dataObj valueForKeyPath:@"@distinctUnionOfObjects.self"],
      @[]);
  XCTAssertEqualObjects(
      [optUnmanaged.dateObj valueForKeyPath:@"@distinctUnionOfObjects.self"],
      @[]);
  XCTAssertEqualObjects(
      [managed.boolObj valueForKeyPath:@"@distinctUnionOfObjects.self"], @[]);
  XCTAssertEqualObjects(
      [managed.intObj valueForKeyPath:@"@distinctUnionOfObjects.self"], @[]);
  XCTAssertEqualObjects(
      [managed.floatObj valueForKeyPath:@"@distinctUnionOfObjects.self"], @[]);
  XCTAssertEqualObjects(
      [managed.doubleObj valueForKeyPath:@"@distinctUnionOfObjects.self"], @[]);
  XCTAssertEqualObjects(
      [managed.stringObj valueForKeyPath:@"@distinctUnionOfObjects.self"], @[]);
  XCTAssertEqualObjects(
      [managed.dataObj valueForKeyPath:@"@distinctUnionOfObjects.self"], @[]);
  XCTAssertEqualObjects(
      [managed.dateObj valueForKeyPath:@"@distinctUnionOfObjects.self"], @[]);
  XCTAssertEqualObjects(
      [optManaged.boolObj valueForKeyPath:@"@distinctUnionOfObjects.self"],
      @[]);
  XCTAssertEqualObjects(
      [optManaged.intObj valueForKeyPath:@"@distinctUnionOfObjects.self"], @[]);
  XCTAssertEqualObjects(
      [optManaged.floatObj valueForKeyPath:@"@distinctUnionOfObjects.self"],
      @[]);
  XCTAssertEqualObjects(
      [optManaged.doubleObj valueForKeyPath:@"@distinctUnionOfObjects.self"],
      @[]);
  XCTAssertEqualObjects(
      [optManaged.stringObj valueForKeyPath:@"@distinctUnionOfObjects.self"],
      @[]);
  XCTAssertEqualObjects(
      [optManaged.dataObj valueForKeyPath:@"@distinctUnionOfObjects.self"],
      @[]);
  XCTAssertEqualObjects(
      [optManaged.dateObj valueForKeyPath:@"@distinctUnionOfObjects.self"],
      @[]);
  ...
  [unmanaged.dateObj addObjects:@[ date(1), date(2), date(1), date(2) ]];
  [optUnmanaged.boolObj
      addObjects:@[ @NO, @YES, NSNull.null, @NO, @YES, NSNull.null ]];
  [optUnmanaged.intObj
      addObjects:@[ @2, @3, NSNull.null, @2, @3, NSNull.null ]];
  [optUnmanaged.floatObj
      addObjects:@[ @2.2f, @3.3f, NSNull.null, @2.2f, @3.3f, NSNull.null ]];
  [optUnmanaged.doubleObj
      addObjects:@[ @2.2, @3.3, NSNull.null, @2.2, @3.3, NSNull.null ]];
  [optUnmanaged.stringObj
      addObjects:@[ @"a", @"b", NSNull.null, @"a", @"b", NSNull.null ]];
  [optUnmanaged.dataObj addObjects:@[
    data(1), data(2), NSNull.null, data(1), data(2), NSNull.null
  ]];
  [optUnmanaged.dateObj addObjects:@[
...
- (void)testSetValueForKey {
  RLMAssertThrowsWithReason(
      [unmanaged.boolObj setValue:@0 forKey:@"not self"],
      @"this class is not key value coding-compliant for the key not self.");
  RLMAssertThrowsWithReason(
      [unmanaged.intObj setValue:@0 forKey:@"not self"],
      @"this class is not key value coding-compliant for the key not self.");
  RLMAssertThrowsWithReason(
      [unmanaged.floatObj setValue:@0 forKey:@"not self"],
      @"this class is not key value coding-compliant for the key not self.");
  RLMAssertThrowsWithReason(
      [unmanaged.doubleObj setValue:@0 forKey:@"not self"],
      @"this class is not key value coding-compliant for the key not self.");
  RLMAssertThrowsWithReason(
      [unmanaged.stringObj setValue:@0 forKey:@"not self"],
      @"this class is not key value coding-compliant for the key not self.");
  RLMAssertThrowsWithReason(
      [unmanaged.dataObj setValue:@0 forKey:@"not self"],
      @"this class is not key value coding-compliant for the key not self.");
  RLMAssertThrowsWithReason(
      [unmanaged.dateObj setValue:@0 forKey:@"not self"],
      @"this class is not key value coding-compliant for the key not self.");
  RLMAssertThrowsWithReason(
      [optUnmanaged.boolObj setValue:@0 forKey:@"not self"],
      @"this class is not key value coding-compliant for the key not self.");
  RLMAssertThrowsWithReason(
      [optUnmanaged.intObj setValue:@0 forKey:@"not self"],
      @"this class is not key value coding-compliant for the key not self.");
  RLMAssertThrowsWithReason(
      [optUnmanaged.floatObj setValue:@0 forKey:@"not self"],
      @"this class is not key value coding-compliant for the key not self.");
  RLMAssertThrowsWithReason(
      [optUnmanaged.doubleObj setValue:@0 forKey:@"not self"],
      @"this class is not key value coding-compliant for the key not self.");
  RLMAssertThrowsWithReason(
      [optUnmanaged.stringObj setValue:@0 forKey:@"not self"],
      @"this class is not key value coding-compliant for the key not self.");
  RLMAssertThrowsWithReason(
      [optUnmanaged.dataObj setValue:@0 forKey:@"not self"],
      @"this class is not key value coding-compliant for the key not self.");
  RLMAssertThrowsWithReason(
      [optUnmanaged.dateObj setValue:@0 forKey:@"not self"],
      @"this class is not key value coding-compliant for the key not self.");
  RLMAssertThrowsWithReason(
      [managed.boolObj setValue:@0 forKey:@"not self"],
      @"this class is not key value coding-compliant for the key not self.");
  RLMAssertThrowsWithReason(
      [managed.intObj setValue:@0 forKey:@"not self"],
      @"this class is not key value coding-compliant for the key not self.");
  RLMAssertThrowsWithReason(
      [managed.floatObj setValue:@0 forKey:@"not self"],
      @"this class is not key value coding-compliant for the key not self.");
  RLMAssertThrowsWithReason(
      [managed.doubleObj setValue:@0 forKey:@"not self"],
      @"this class is not key value coding-compliant for the key not self.");
  RLMAssertThrowsWithReason(
      [managed.stringObj setValue:@0 forKey:@"not self"],
      @"this class is not key value coding-compliant for the key not self.");
  RLMAssertThrowsWithReason(
      [managed.dataObj setValue:@0 forKey:@"not self"],
      @"this class is not key value coding-compliant for the key not self.");
  RLMAssertThrowsWithReason(
      [managed.dateObj setValue:@0 forKey:@"not self"],
      @"this class is not key value coding-compliant for the key not self.");
  RLMAssertThrowsWithReason(
      [optManaged.boolObj setValue:@0 forKey:@"not self"],
      @"this class is not key value coding-compliant for the key not self.");
  RLMAssertThrowsWithReason(
      [optManaged.intObj setValue:@0 forKey:@"not self"],
      @"this class is not key value coding-compliant for the key not self.");
  RLMAssertThrowsWithReason(
      [optManaged.floatObj setValue:@0 forKey:@"not self"],
      @"this class is not key value coding-compliant for the key not self.");
  RLMAssertThrowsWithReason(
      [optManaged.doubleObj setValue:@0 forKey:@"not self"],
      @"this class is not key value coding-compliant for the key not self.");
  RLMAssertThrowsWithReason(
      [optManaged.stringObj setValue:@0 forKey:@"not self"],
      @"this class is not key value coding-compliant for the key not self.");
  RLMAssertThrowsWithReason(
      [optManaged.dataObj setValue:@0 forKey:@"not self"],
      @"this class is not key value coding-compliant for the key not self.");
  RLMAssertThrowsWithReason(
      [optManaged.dateObj setValue:@0 forKey:@"not self"],
      @"this class is not key value coding-compliant for the key not self.");
  ...
  RLMAssertThrowsWithReason([unmanaged.doubleObj setValue:@"a" forKey:@"self"],
                            ...
                            @"for expected type 'double'");
  RLMAssertThrowsWithReason(
      [unmanaged.stringObj setValue:@2 forKey:@"self"],
      @"Invalid value '2' of type '__NSCFNumber' for expected type 'string'");
  ...
  RLMAssertThrowsWithReason([optUnmanaged.doubleObj setValue:@"a"
                            ...
                            @"for expected type 'double?'");
  RLMAssertThrowsWithReason(
      [optUnmanaged.stringObj setValue:@2 forKey:@"self"],
      @"Invalid value '2' of type '__NSCFNumber' for expected type 'string?'");
  ...
  RLMAssertThrowsWithReason([managed.doubleObj setValue:@"a" forKey:@"self"],
                            ...
                            @"for expected type 'double'");
  RLMAssertThrowsWithReason(
      [managed.stringObj setValue:@2 forKey:@"self"],
      @"Invalid value '2' of type '__NSCFNumber' for expected type 'string'");
  ...
  RLMAssertThrowsWithReason([optManaged.doubleObj setValue:@"a" forKey:@"self"],
                            ...
                            @"for expected type 'double?'");
  RLMAssertThrowsWithReason(
      [optManaged.stringObj setValue:@2 forKey:@"self"],
      @"Invalid value '2' of type '__NSCFNumber' for expected type 'string?'");
