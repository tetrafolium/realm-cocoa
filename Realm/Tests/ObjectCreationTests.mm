...
- (void)testInitWithDictionary {
  ...
  co = [[CompanyObject alloc]
      initWithValue:@{@"name" : @"empty company", @"employees" : NSNull.null}];
  XCTAssertEqualObjects(co.name, @"empty company");
  XCTAssertEqual(co.employees.count, 0U);
...
- (void)testInitPrimitiveArraysWithInvalidValues {
  ...
  RLMAssertThrowsWithReason(
      ...
      @"Invalid value '1.1' of type '__NSCFNumber' for 'int' array property "
      @"'AllPrimitiveArrays.intObj'.");
  RLMAssertThrowsWithReason(
...
- (void)testInitAllPropertyTypes {
  ...
  so.stringCol = @"string";
  auto ao = [[AllTypesObject alloc] initWithValue:@[
    @YES, @1, @1.1f, @1.11, @"string", bytes, now, @YES, @11, so
  ]];
...
- (void)testInitValidatesNumberTypes {
  ...
  RLMAssertThrowsWithReason(
      ...
      @"Invalid value '1.1' of type '__NSCFNumber' for 'int?' property "
      @"'NumberObject.intObj'.");
  RLMAssertThrowsWithReason(
  ...
  RLMAssertThrowsWithReason(
      ...
      @"Invalid value '1' of type '__NSCFNumber' for 'bool?' property "
      @"'NumberObject.boolObj'.");
  RLMAssertThrowsWithReason(
  ...
  RLMAssertThrowsWithReason(
      ...
      @"Invalid value '2' of type '__NSCFNumber' for 'bool?' property "
      @"'NumberObject.boolObj'.");
  ...
  RLMAssertThrowsWithReasonMatching(
      ...
      @"Invalid value '.*' of type '__NSCFNumber' for 'float\\?' property "
      @"'NumberObject.floatObj'");
...
- (void)testCreateWithArray {
  ...
  auto co = [CompanyObject createInRealm:realm
                               withValue:@[ @"empty company", NSNull.null ]];
  XCTAssertEqualObjects(co.name, @"empty company");
  XCTAssertEqual(co.employees.count, 0U);
  ...
  co = [CompanyObject
      createInRealm:realm
          withValue:@[ @"one employee", @[ @[ @"name", @2, @YES ] ] ]];
  XCTAssertEqualObjects(co.name, @"one employee");
  XCTAssertEqual(co.employees.count, 1U);
  EmployeeObject *eo = co.employees.firstObject;
  XCTAssertEqualObjects(eo.name, @"name");
...
- (void)testCreateWithDictionary {
  ...
  co = [CompanyObject
      createInRealm:realm
          withValue:@{@"name" : @"empty company", @"employees" : NSNull.null}];
  XCTAssertEqualObjects(co.name, @"empty company");
  XCTAssertEqual(co.employees.count, 0U);

  co = [CompanyObject
      createInRealm:realm
          withValue:@{@"name" : @"empty company", @"employees" : @[]}];
  XCTAssertEqualObjects(co.name, @"empty company");
  XCTAssertEqual(co.employees.count, 0U);
...
- (void)testCreateWithNonArrayEnumerableValueForArrayProperty {
  ...
  auto co = [CompanyObject
      createInRealm:realm
          withValue:@[ @"one employee", employees.reverseObjectEnumerator ]];
  XCTAssertEqual(2U, co.employees.count);
  XCTAssertEqualObjects(@"name 2", co.employees[0].name);
  XCTAssertEqualObjects(@"name", co.employees[1].name);
...
- (void)testAddToDifferentRealmThrows {
  ...
  RLMAssertThrowsWithReason([realm2 addObject:eo],
                            @"Object is already managed by another Realm. Use "
...
- (void)testAddOrUpdateReplacesExistingArrayPropertiesAndDoesNotMergeThem {
  ...
  auto obj2 = [[AllLinksWithPrimary alloc]
      initWithValue:@[ @"pk", @[ @"str" ], @[ @"str pk", @6 ], @[ @[ @4 ] ] ]];
  [realm addOrUpdateObject:obj1];
  [realm addOrUpdateObject:obj2];
