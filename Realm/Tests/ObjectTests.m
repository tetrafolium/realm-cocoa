...
- (void)testDataTypes {
  ...
  [AllTypesObject createInRealm:realm
                      withValue:@[
                        @YES, @506, @7.7f, @8.8, @"banach", bin2, timeNow, @YES,
                        @(-20), NSNull.null
                      ]];
  [realm commitWriteTransaction];
...
- (void)testDate50kYears {
  NSCalendarUnit units = (NSCalendarUnit)(
      NSCalendarUnitMonth | NSCalendarUnitYear | NSCalendarUnitDay);
...
- (void)testAddingObjectNotInSchemaThrows {
  ...
  RLMAssertThrowsWithReasonMatching(
      ...
      @"Object type 'IntObject' is not managed by the Realm.*custom "
      @"`objectClasses`");
  RLMAssertThrowsWithReasonMatching([IntObject createInRealm:realm
                                                   withValue:@[ @1 ]],
                                    @"Object type 'IntObject' is not managed "
                                    @"by the Realm.*custom `objectClasses`");
  XCTAssertNoThrow(
...
- (void)testCreateInRealmValidationForDictionary {
  ...
  NSData *bin1 = [[NSData alloc] initWithBytes:bin length:sizeof bin / 2];
  NSDate *timeNow = [NSDate dateWithTimeIntervalSince1970:1000000];
  NSDictionary *const dictValidAllTypes = @{
    @"boolCol" : @NO,
    @"intCol" : @54,
    @"floatCol" : @0.7f,
    @"doubleCol" : @0.8,
...
- (void)testCreateInRealmValidationForArray {
  ...
  NSArray *const arrayValidAllTypes =
      @[ @NO, @54, @0.7f, @0.8, @"foo", bin1, timeNow, @NO, @(99), to ];
...
- (void)testCreateInRealmReusesExistingNestedObjectsByPrimaryKey {
  ...
  PrimaryCompanyObject *co =
      [PrimaryCompanyObject createInRealm:realm
                                withValue:@[ @"Realm", @[ eo ], eo, @[ eo ] ]];
  [realm commitWriteTransaction];
  ...
  [PrimaryCompanyObject
      createOrUpdateInRealm:realm
                  withValue:@{@"name" : @"Realm", @"wrappedIntern" : @[ eo ]}];
  [realm commitWriteTransaction];
  XCTAssertEqual(1U, [[PrimaryEmployeeObject allObjectsInRealm:realm] count]);
}
...
- (void)testCreateOrUpdate {
  ...
  XCTAssertEqual([(PrimaryNullableStringObject *)objects[0] intCol], 1,
                 @"Value should be 1");
  ...
  XCTAssertEqual([(PrimaryNullableStringObject *)objects[0] intCol], 3,
                 @"Value should be 3");
