...
/**
   A homogenous collection of Realm-managed objects. Examples of conforming
   types include `RLMArray`, `RLMResults`, and `RLMLinkingObjects`.
 */
...
/**
   Returns the index of the first object in the collection matching the
   predicate.
...
/**
   ...
   indices in the collection for each type of change, and an array of index
   paths in a requested section suitable for passing directly to `UITableView`'s
   batch update methods. A complete example of updating a `UITableView` named
   `tv`:
