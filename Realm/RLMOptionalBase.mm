...
public:
  ManagedOptional(RLMObjectBase *obj, RLMProperty *prop)
      : _realm(obj->_realm),
        ...
        _propertyName(prop.name.UTF8String), _ctx(*obj->_info) {}
...
- (BOOL)isKindOfClass:(Class)aClass {
  return [RLMGetOptional(self) isKindOfClass:aClass] ||
...
void RLMSetOptional(__unsafe_unretained RLMOptionalBase *const self,
...
void RLMInitializeManagedOptional(
    __unsafe_unretained RLMOptionalBase *const self,
...
void RLMInitializeUnmanagedOptional(
    __unsafe_unretained RLMOptionalBase *const self,
    __unsafe_unretained RLMObjectBase *const parent,
    __unsafe_unretained RLMProperty *const prop) {
  if (!self->_impl) {
