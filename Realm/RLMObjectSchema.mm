...
+ (instancetype)schemaForObjectClass:(Class)objectClass {
	...
	bool isSwift =
		hasSwiftName || [objectClass isSubclassOfClass:s_swiftObjectClass];
...
+ (NSArray *)propertiesForClass:(Class)objectClass isSwift:(bool)isSwiftClass {
	...
	if (NSArray<RLMProperty *> *props =
		    [objectClass _getPropertiesWithInstance:swiftObjectInstance]) {
		return props;
	}
...
- (id)copyWithZone:(NSZone *)zone {
	...
	schema.properties = [[NSArray allocWithZone:zone] initWithArray:_properties
	                     copyItems:YES];
