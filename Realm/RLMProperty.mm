...
static realm::util::Optional<RLMPropertyType>
typeFromProtocolString(const char *type) {
...
- (BOOL)setTypeFromRawType:(NSString *)rawType {
	...
	if (strcmp(code, "@\"NSString\"") == 0) {
		...
		_objectClassName = [[NSString alloc]
		                    initWithBytes:code + arrayPrefixLen
		...
		@throw RLMException(
			       ...
			       @"See https://realm.io/docs/objc/latest/#to-many for more information.",
		...
		@throw RLMException(
			       @"Property '%@' is of type %s which is not a supported NSNumber object "
			       @"type. "
			       @"NSNumbers can only be RLMInt, RLMFloat, RLMDouble, and RLMBool at "
			       @"the moment. "
			       @"See https://realm.io/docs/objc/latest for more information.",
			       _name, code + 1);
		...
		if (!cls) {
			@throw RLMException(
				       @"Property '%@' is declared as '%@', which is not a supported "
				       @"RLMObject property type. "
				       @"All properties must be primitives, NSString, NSDate, NSData, "
				       @"NSNumber, RLMArray, RLMLinkingObjects, or subclasses of RLMObject. "
				       @"See https://realm.io/docs/objc/latest/api/Classes/RLMObject.html "
...
- (instancetype)initSwiftPropertyWithName:(NSString *)name
	...
	// subclasses of RLMObject (but not RealmSwift.Object). It's unclear if
	...
	//        * if the Realm Objective-C Swift tests pass with this removed, it's
	//        been fixed
	...
	if ([rawType isEqualToString:@"@\"RLMArray\""]) {
		...
		if (_type == RLMPropertyTypeObject &&
			...
			@throw RLMException(
				       ...
				       @"RLMArray object type. "
				       @"RLMArrays can only contain instances of RLMObject subclasses. "
				       @"See https://realm.io/docs/objc/latest/#to-many for more "
				       @"information.",
				       _name, _objectClassName);
		}
