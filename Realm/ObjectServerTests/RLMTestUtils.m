...
static void RLMSwapOutMethod(Class class, SEL original, Method originalMethod,
                             SEL swizzled, Method swizzledMethod) {
  if (class_addMethod(class, original, method_getImplementation(swizzledMethod),
...
void RLMSwapOutClassMethod(id classObject, SEL original, SEL swizzled) {
  ...
  RLMSwapOutMethod(class, original, class_getClassMethod(class, original),
...
void RLMSwapOutInstanceMethod(id classObject, SEL original, SEL swizzled) {
  ...
  RLMSwapOutMethod(class, original, class_getInstanceMethod(class, original),
